use ex_24_08_accumulator_server::spawn_accumulator_server;
...
fn concurrent_adds_accumulate_correctly() {
    ...
    for i in 1..=20i64 {
        handles.push(thread::spawn(move || {
            ...
            // каждый ответ - какое-то валидное промежуточное значение
    ...
    // после всех ADD итог детерминирован: сумма 1..=20
